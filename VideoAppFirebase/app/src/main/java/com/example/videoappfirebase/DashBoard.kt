...
class DashBoard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var lession2 = "https://firebasestorage.googleapis.com/v0/b/videoappfirebase-283eb.appspot.com/o/1.%20Install%20The%20IDE%20for%20Learn%20Kotlin.mp4?alt=media&token=0060b771-9814-4aa0-ba05-711af394517d"

        var items = ArrayList<Lession>()
        items.add(Lession("Android Development","Learn Android From Zero To Hero",lession1))
        items.add(Lession("Android Development","Learn Android From Zero To Hero",lession2))
        items.add(Lession("Android Development","Learn Android From Zero To Hero",lession1))
        items.add(Lession("Android Development","Learn Android From Zero To Hero",lession1))
